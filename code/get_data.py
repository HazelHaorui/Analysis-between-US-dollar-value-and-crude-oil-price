...
def download_usdindex_json(json_name):
    url = 'https://api.scraperlink.com/investpy/?email=xxx@gmail.com&type=historical_data&product=indices&from_date=2013-01-01&to_date=2022-11-22&time_frame=Daily&symbol=DXY'
